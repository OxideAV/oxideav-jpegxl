...
#[test]
fn idct_for_transform_non_dct_transforms_return_unsupported() {
    // Hornuss, DCT2×2, DCT4×4, DCT4×8, DCT8×4, AFV0..AFV3 use the
    // I.2.3.3..I.2.3.8 non-DCT IDCT paths; they're explicitly deferred
    // to round 13+.
    for t in [
        ...
        assert!(r.is_err(), "{t:?}: expected Err");
    }
}
